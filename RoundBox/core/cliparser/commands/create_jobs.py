...
from RoundBox.core.cliparser.utils import _make_writeable, signalcommand


class Command(AppCommand):
    help = "Creates a RoundBox jobs command directory structure for the given app name in the current directory."
...
def copy_template(template_name, copy_to, **options):
    ...
    template_dir = os.path.join(RoundBox.__path__[0], 'conf', template_name)
