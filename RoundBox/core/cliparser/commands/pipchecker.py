...
# https://github.com/django-extensions/django-extensions/blob/main/django_extensions/management/commands/pipchecker.py
...
class Command(BaseCommand):
    ...
    def _urlopen_as_json(self, url: str, headers=None) -> dict:
        """Shortcut for return contents as json
    ...
    def _available_version(self, dist_version, available) -> LooseVersion:
        """
